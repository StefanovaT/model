...
| :----------------------------------- | :-------------------: | :----------------------------------------: | :---------------------------------- | :---------------------------------------- | :----------------------------------------------------------- |
| MarketingActivityLineToSalesOrderLine |       MStandardQuantityBase       |        MarketingActivityLine.Product.BaseMeasurementCategory.BaseUnit         |  CONVERT(MarketingActivityLine.Quantity, MarketingActivityLine.Product.BaseMeasurementCategory.BaseUnit)             | SalesOrderLine.StandardQuantityBase             | YES |
...
SalesOrderLine.Quantity = CONVERT( REMAINING(MarketingActivityLine.MStandardQuantityBase), MarketingActivityLine.QuantityUnit)
