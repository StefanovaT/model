...
This generation is used to create Sales Orders from Marketing Activities. <br>
Thе generation is single execution only. If there are unfulfilled quantities from the Marketing Activity there will be no automatically generated documents for the differences. You can still create an execution for the differences by manually starting the generation.
