...
| :----------------------------------- | :-------------------: | :----------------------------------------: | :---------------------------------- | :---------------------------------------- | :----------------------------------------------------------- |
| MarketingActivityLineToSalesOrderLine |       MQuantity       |        MarketingActivityLine.Product.BaseMeasurementCategory.BaseUnit         |  CONVERT(MarketingActivityLine.Quantity, MarketingActivityLine.Product.BaseMeasurementCategory.BaseUnit)             | SalesOrderLine.StandartQuantity             | YES |
...
SalesOrderLine.Quantity = MarketingActivityLine.REMAINING(MQuantityUnit)
