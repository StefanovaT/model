...
The SO for the products that have already been issued from the other store is created by another generation procedure - [LOG0211](LOG0211.md). Both generation procedures are usually set up simultaneously for the same ТО. As one provides details about what has already been issued (LOG0211), the other shows what remains to be issued and is planned to be received (LOG0212).
