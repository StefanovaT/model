...
VAT amount and VAT base for the specified deal type are calculated as described in [Defining VAT And Base For VAT Entries](tech/modules/financials/VAT/defining-vat-and-base-for-vat-entries.md).
