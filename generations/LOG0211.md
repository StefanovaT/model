...
The SO for the products that have not been issued yet is created by another generation procedure - [LOG0212](LOG0212.md). Both generation procedures are usually set up simultaneously for the same ТО. As one provides details about what has already been issued (LOG0211), the other shows what remains to be issued and is planned to be received (LOG0212).
