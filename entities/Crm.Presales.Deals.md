...
| [Party](Crm.Presales.Deals.md#party) | [Parties](General.Contacts.Parties.md) | The prospect customer's party. The party might not yet have a customer record. `Required` `Filter(multi eq)` |
