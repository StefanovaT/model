...
_{LineNo}. {StoreOrder.DocumentNo} {StoreOrder.DocumentType.TypeName:T}{StateTagsAttribute}_  
...
| [StateTagsAttribute](Logistics.Inventory.StoreOrderLines.md#statetagsattribute) | string | Specifies the state of the document. 
