...
_{Id}. {PaymentTransaction.DocumentNo} {PaymentTransaction.DocumentType.TypeName:T}{StateTagsAttribute}_  
...
| [StateTagsAttribute](Finance.Payments.PaymentTransactionLines.md#statetagsattribute) | string | Specifies the state of the document. 
