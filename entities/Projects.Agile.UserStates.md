...
| CONSIDER | CONSIDER. Stored as '2'. <br /> _Model Value:_ 1 <br /> _Domain API Value:_ 'CONSIDER' |
| READY | READY. Stored as '3'. <br /> _Database Value:_ '2' <br /> _Model Value:_ 2 <br /> _Domain API Value:_ 'READY' |
| INPROGRESS | IN PROGRESS. Stored as '4'. <br /> _Database Value:_ '3' <br /> _Model Value:_ 3 <br /> _Domain API Value:_ 'INPROGRESS' |
| WAITING | WAITING. Stored as '5'. <br /> _Database Value:_ '4' <br /> _Model Value:_ 4 <br /> _Domain API Value:_ 'WAITING' |
| RESOLVED | RESOLVED. Stored as '6'. <br /> _Database Value:_ '5' <br /> _Model Value:_ 5 <br /> _Domain API Value:_ 'RESOLVED' |
| CLOSED | CLOSED. Stored as '7'. <br /> _Database Value:_ '6' <br /> _Model Value:_ 6 <br /> _Domain API Value:_ 'CLOSED' |
