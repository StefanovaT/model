...
| - | - | --- |
|[Deactivation_Date](#deactivation_date)|`datetime` |The date when the license was deactivated.|
...
|[Notes](#notes)|`nvarchar(max)` |Additional license notes.|
|[Origin](#origin)|`nvarchar(256)` |The origin of this license.|
|[Provider](#provider)|`nvarchar(256)` |The license provider - e.g., a local file.|
|[Scope](#scope)|`nvarchar(32)` |The scope of the license.|
...
The date when the license was deactivated.
...
The license provider - e.g., a local file.
