...
| - | - | --- |
|[Count](#count)|`int` |Total number of messages|
|[Process](#process)|`nvarchar(254)` |Process description for message.|
|[Size_MB](#size_mb)|`bigint` |Total used size for message type in Megabytes.|
