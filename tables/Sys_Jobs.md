...
|[Job_Type](#job_type)|`nvarchar(3)` Allowed: `DOC`, `POS`, `DNT`, `DPI`, `DDV`, `DIM`|The system type of the job. DOC=Document Change State, POS=Run Postponed Events, DNT=Delete Old Notifications, DPI=Delete Old Print Images, DDV=Delete Old Document Versions, DIM=Delete Old Information Messages.|
...
| Property | Value |
| - | - |
|Allowed Values|`DOC`, `POS`, `DNT`, `DPI`, `DDV`, `DIM`|
|Auto Complete|no|
|Data Filter|no|
|Default Value|None|
|Enter Stop|yes|
