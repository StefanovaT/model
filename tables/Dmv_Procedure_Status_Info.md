# View Dmv_Procedure_Status_Info


## Entity

Entity: [Systems.Monitoring.ProcedureStatusInfo](~/entities/Systems.Monitoring.ProcedureStatusInfo.md)
...
#### ElapsedPercent - Supported Filters
