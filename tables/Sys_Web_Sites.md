...
|[Web_Site_Type](#web_site_type)|`nvarchar(3)` Allowed: `API`, `CC`, `EC`, `LEG`, `SI`, `DM`, `APP`, `TAP`, `DAP`, `LUK`|The type of web site - Api, Client Center, Id, etc.|
...
| Property | Value |
| - | - |
|Allowed Values|`API`, `CC`, `EC`, `LEG`, `SI`, `DM`, `APP`, `TAP`, `DAP`, `LUK`|
|Auto Complete|no|
|Data Filter|no|
|Default Value|None|
|Enter Stop|yes|
