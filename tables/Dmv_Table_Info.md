...
| - | - | --- |
|[Row_Count](#row_count)|`bigint` |Total number of rows|
|[Size_MB](#size_mb)|`decimal(12, 3)` |Total used size of the table in Megabytes.|
|[Table_Name](#table_name)|`nvarchar(128)` |The name of the table, for which we provide the data.|
