...
|[Sync_Protocol](#sync_protocol)|`nvarchar(6)` Allowed: `IMAP`, `POP3`, `MEWS`, `NOSYNC`|Synchronization protocol, 'POP3' or 'IMAP'. NULL means that syncrhonization is not setup|
...
| Property | Value |
| - | - |
|Allowed Values|`IMAP`, `POP3`, `MEWS`, `NOSYNC`|
|Auto Complete|no|
|Data Filter|no|
|Default Value|None|
|Enter Stop|yes|
