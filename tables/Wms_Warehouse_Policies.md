...
|[Policy_Kind](#policy_kind)|`nvarchar(3)` Allowed: `APC`, `ATC`, `ALC`, `AUC`, `RSS`, `RDS`, `ALS`, `ZTY`, `KCL`, `DCL`, `GCP`, `GNS`, `RPS`|The kind of policy, which is being applied.|
...
| Property | Value |
| - | - |
|Allowed Values|`APC`, `ATC`, `ALC`, `AUC`, `RSS`, `RDS`, `ALS`, `ZTY`, `KCL`, `DCL`, `GCP`, `GNS`, `RPS`|
|Auto Complete|no|
|Data Filter|no|
|Default Value|None|
|Enter Stop|yes|
