...
|[Policy_Kind](#policy_kind)|`nvarchar(3)` Allowed: `ALS`, `ALC`, `ATC`, `APC`, `AUC`, `DCL`, `GCP`, `GNS`, `KCL`, `RDS`, `RPS`, `RSS`, `ZTY`, `CRO`, `UOS`, `SOS`, `AOS`|The kind of policy, which is being applied.|
...
| Property | Value |
| - | - |
|Allowed Values|`ALS`, `ALC`, `ATC`, `APC`, `AUC`, `DCL`, `GCP`, `GNS`, `KCL`, `RDS`, `RPS`, `RSS`, `ZTY`, `CRO`, `UOS`, `SOS`, `AOS`|
|Auto Complete|no|
|Data Filter|no|
|Default Value|None|
|Enter Stop|yes|
