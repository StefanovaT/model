...
|[Policy_Kind](#policy_kind)|`nvarchar(3)` Allowed: `ALC`, `ALS`, `APC`, `ATC`, `AUC`, `DCL`, `GCP`, `GNS`, `KCL`, `RDS`, `RPS`, `RSS`, `ZTY`|The kind of policy, which is being applied.|
...
| Property | Value |
| - | - |
|Allowed Values|`ALC`, `ALS`, `APC`, `ATC`, `AUC`, `DCL`, `GCP`, `GNS`, `KCL`, `RDS`, `RPS`, `RSS`, `ZTY`|
|Auto Complete|no|
|Data Filter|no|
|Default Value|None|
|Enter Stop|yes|
