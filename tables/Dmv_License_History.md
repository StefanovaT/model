...
|[License_Count](#license_count)|`int` |The number of licenses given (+) or taken (-).|
|[License_Description](#license_description)|`nvarchar(max)` |Description of the license code.|
|[License_End_Date](#license_end_date)|`date` |The date (inclusive), until the license is active.|
|[License_Scale_Type](#license_scale_type)|`nvarchar(64)` |Denotes whether the license supports counts, different from 0 and 1.|
|[License_Start_Date](#license_start_date)|`date` |The date (inclusive), from which the license is active.|
|[Licensing_Date](#licensing_date)|`date` |The date, when the license was issued.|
|[Licensing_Event](#licensing_event)|`nvarchar(128)` |Unique licensing event key. Can be used to group all license codes given with a single licensing event.|
...
#### License_End_Date - Supported Filters
...
#### License_Start_Date - Supported Filters
...
#### Licensing_Date - Supported Filters
